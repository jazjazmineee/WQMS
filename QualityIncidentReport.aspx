<%@ Page Title="" Language="C#" MasterPageFile="~/Sidebar.Master" AutoEventWireup="true" CodeBehind="QualityIncidentReport.aspx.cs" Inherits="WaterGuard_2024.QualityIncidentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main p-4 mt-5">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h1 mb-0 text-gray-800">Quality Incident Report Page</h1>
        </div>
        ...
        <div class="col-lg-12 mb-4">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-end">
                    <asp:LinkButton ID="ShowAllDatesLinkButton" runat="server" Text="Show All" OnClick="ShowAllDates_Click" Font-Size="Large" AutoPostBack="true" />
                </div>
                <div class="card-body">
